...
async function createRepo(owner: string, repoName: string, token: string) {
    ...
    try {
        ...
        if (repoCheckResponse.status === 404) {
            ...
            if (!createRepoResponse.ok) {
                ...
                throw new Error(`Failed to create repository: ${data.message || 'Unknown error'}`);
            }
        ...
        // Step 3: Push the file to the repository
        ...
        try {
            ...
            // File likely doesn't exist, which is fine for a new repo.
        }
